...
export async function POST(request) {
  try {
    const { name, discription, sourcelink, imgs, category } = await request.json();
    await connectMongo();
    const project = new Project({ name, discription, sourcelink, imgs, category });
    await project.save();
...
export async function PUT(request) {
  try {
    const { id, name, discription, sourcelink, imgs, category } = await request.json();
    await connectMongo();
